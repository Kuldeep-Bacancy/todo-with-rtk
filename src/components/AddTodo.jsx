...
import { addTodo, updateTodo, currentEditTodoID } from '../features/todo/todoSlice'
...
function AddTodo() {
  ...
  return (
    <form onSubmit={editTodoID ? updateTodoHandler : addTodoHandler} className="space-x-3 mt-12">
      <input
        type="text"
